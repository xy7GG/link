...
import com.xy7.shortlink.admin.dao.entity.UserPhoneDO;
...
public interface UserPhoneMapper extends BaseMapper<UserPhoneDO> {
     ...
     * 注销用户
     */
    @Update("update t_user_phone set deletion_time = #{userPhoneDO.deletionTime}, del_flag = '1' where phone = #{userPhoneDO.phone} and del_flag = '0'")
