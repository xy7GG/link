...
import com.xy7.shortlink.admin.common.enums.UserChainMarkEnum;
import com.xy7.shortlink.admin.dao.entity.*;
import com.xy7.shortlink.admin.dao.mapper.*;
...
import com.xy7.shortlink.framework.starter.convention.errorcode.BaseErrorCode;
...
import com.xy7.shortlink.framework.starter.designpattern.chain.AbstractChainContext;
import com.xy7.shortlink.framework.starter.user.core.UserContext;
import com.xy7.shortlink.framework.starter.user.core.UserInfoDTO;
import com.xy7.shortlink.framework.starter.user.toolkit.JWTUtil;
...
import static com.xy7.shortlink.admin.common.constant.RedisCacheConstant.*;
import static com.xy7.shortlink.admin.common.enums.UserErrorCodeEnum.*;
import static com.xy7.shortlink.admin.toolkit.UserReuseUtil.hashShardingIdx;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, UserDO> implements UserService {
    ...
    public void register(UserRegisterReqDTO requestParam) {
        ...
        try{
            ...
            }catch (DuplicateKeyException aw){
            ...
            if (StrUtil.isNotBlank(requestParam.getMail())) {
                ...
                try {
                    ...
                    throw new ClientException(MAIL_REGISTERED);
                }
            }
    ...
    public void update(UserUpdateReqDTO requestParam) {
        UserRespDTO userQueryRespDTO = getUserByUsername(requestParam.getUsername());
        UserDO userDO = com.xy7.shortlink.framework.starter.common.toolkit.BeanUtil.convert(requestParam, UserDO.class);
    ...
    public void deletion(UserDeletionReqDTO requestParam) {
        ...
        lock.lock();
        try {
            UserRespDTO userQueryRespDTO = getUserByUsername(username);
